...
def test_it_adds_websites_that_have_recently_been_scraped(setup, response_body):
    updated_website_ids = [w['website_id'] for w in response_body['websites']]
    assert setup['other_website_id'] in updated_website_ids
